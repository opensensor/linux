...
/* OSD */
#define NR_MAX_OSD_REGION			64
#define NR_MAX_OSD_GROUPS			4
#define NR_MAX_OSD_OUTPUT_IN_GROUP	3

extern struct task_struct *osd_task;
...
typedef struct twoBitAttr{
	uint32_t twobit_mask;					/* 2bit mask */
	uint32_t twobit_bit0_fmt;				/* bit 0 data The top 8 digits represent transparency, while the other digits represent color */
	uint32_t twobit_bit1_fmt;				/* bit 1 data The top 8 digits represent transparency, while the other digits represent color */
} IMPOSD2BitAttr;
...
typedef struct {
	...
	IMPOSD2BitAttr		bitAttr;		/**< 2bit data */
} IMPOSDRgnAttr;
...
typedef struct {
	IMPOSDRgnAttr		rAttr[NR_MAX_OSD_REGION];
} IMPOsdGroup;
...
enum
{
	IMP_OK_OSD_ALL					= 0x0 ,
	/* OSD */
	IMP_ERR_OSD_CHNID				= 0x80020001,
	IMP_ERR_OSD_PARAM				= 0x80020002,
	IMP_ERR_OSD_EXIST				= 0x80020004,
	IMP_ERR_OSD_UNEXIST				= 0x80020008,
	IMP_ERR_OSD_NULL_PTR			= 0x80020010,
	IMP_ERR_OSD_NOT_CONFIG			= 0x80020020,
	IMP_ERR_OSD_NOT_SUPPORT			= 0x80020040,
	IMP_ERR_OSD_PERM				= 0x80020080,
	IMP_ERR_OSD_NOMEM				= 0x80020100,
	IMP_ERR_OSD_NOBUF				= 0x80020200,
	IMP_ERR_OSD_BUF_EMPTY			= 0x80020400,
	IMP_ERR_OSD_BUF_FULL			= 0x80020800,
	IMP_ERR_OSD_BUF_SIZE			= 0x80021000,
	IMP_ERR_OSD_SYS_NOTREADY		= 0x80022000,
	IMP_ERR_OSD_OVERTIME			= 0x80024000,
	IMP_ERR_OSD_RESOURCE_REQUEST	= 0x80028000,
};
