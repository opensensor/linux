...
#define GLB0_BURST_INCR8		(0x1)
#define GLB0_BURST_INCR16		(0x2)
#define GLB0_BURST_INCR32		(0x3)
...
#define DMA_OPS			1
#define CPU_OPS			0
#ifdef CONFIG_SFC_PIO_MODE
#define OPS_MODE CPU_OPS
#else
#define OPS_MODE DMA_OPS
#endif
...
#define THRESHOLD		32
#define BURST_MD		32	// T40 and A1 are set to incr16
