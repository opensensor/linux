...
/*
 * T31 SFC v1 register definitions (from x1000 soc/sfc.h).
 * The PRJ007 soc/sfc.h has v2 register names (SFC_GLB0, SFC_TRAN_CONF0, CDT)
 * which are incompatible with the v1 driver. Include the correct v1 defs here.
 */
...
/* TRAN_CONF_ prefixed aliases used by ingenic_sfc_common.c */
#define TRAN_CONF_TRAN_MODE_OFFSET	TRAN_MODE_OFFSET
#define TRAN_CONF_TRAN_MODE_MSK		TRAN_MODE_MSK
#define TRAN_CONF_ADDR_WIDTH_OFFSET	ADDR_WIDTH_OFFSET
#define TRAN_CONF_ADDR_WIDTH_MSK	ADDR_WIDTH_MSK
#define TRAN_CONF_POLLEN		POLLEN
#define TRAN_CONF_POLL_OFFSET		(25)
#define TRAN_CONF_CMDEN			CMDEN
#define TRAN_CONF_FMAT			FMAT
#define TRAN_CONF_FMAT_OFFSET		(23)
#define TRAN_CONF_DMYBITS_OFFSET	DMYBITS_OFFSET
#define TRAN_CONF_DMYBITS_MSK		DMYBITS_MSK
#define TRAN_CONF_DATEEN		DATEEN
#define TRAN_CONF_DATEEN_OFFSET		(16)
#define TRAN_CONF_CMD_OFFSET		CMD_OFFSET
#define TRAN_CONF_CMD_MSK		CMD_MSK
