...
/* PRJ007 Used in device tree for gpio settings. eg, <&gpb 0, GPIO_ACTIVE_LOW INGENIC_GPIO_PULL_UP | INGENIC_GPIO_DS_0> */
/* PRJ008 Used in device tree for gpio settings. eg, <&gpb 0, GPIO_ACTIVE_LOW INGENIC_GPIO_PULL_UP | INGENIC_GPIO_DS_MODE_1> */
...
#define INGENIC_GPIO_DS_MSK		0xf

#ifdef CONFIG_SOC_PRJ007
#define INGENIC_GPIO_DS_2		(2 << INGENIC_GPIO_DS_SFT)
#define INGENIC_GPIO_DS_4		(4 << INGENIC_GPIO_DS_SFT)
#define INGENIC_GPIO_DS_8		(8 << INGENIC_GPIO_DS_SFT)
#define INGENIC_GPIO_DS_12		(12 << INGENIC_GPIO_DS_SFT)
#else
#define INGENIC_GPIO_DS_MODE_1		(1 << INGENIC_GPIO_DS_SFT)
#define INGENIC_GPIO_DS_MODE_2		(2 << INGENIC_GPIO_DS_SFT)
#define INGENIC_GPIO_DS_MODE_3		(3 << INGENIC_GPIO_DS_SFT)
#define INGENIC_GPIO_DS_MODE_4		(4 << INGENIC_GPIO_DS_SFT)
#endif

#define INGENIC_GPIO_SLEW_RATE_SFT	7
#define INGENIC_GPIO_SLEW_RATE		(1 << INGENIC_GPIO_SLEW_RATE_SFT)

#define INGENIC_GPIO_SCHMITT_SFT	8
...
#define INGENIC_GPIO_SCHMITT_ENABLE(x)	((x) >> INGENIC_GPIO_SCHMITT_SFT & 0x1)
#define INGENIC_GPIO_SLEW_RATE_ENABLE(x) ((x) >> INGENIC_GPIO_SLEW_RATE_SFT & 0x1)
